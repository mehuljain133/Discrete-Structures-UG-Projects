#Create a class RELATION, use Matrix notation to represent a relation. Include functionsto check if the relation is Reflexive, Symmetric, Anti-symmetric and Transitive. Write aProgram to use this class
...
def main():
    try:
        ...
        # Check if the relation is reflexive, symmetric, anti-symmetric, and transitive
